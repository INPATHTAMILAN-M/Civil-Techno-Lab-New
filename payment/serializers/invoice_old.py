...
from ..models import (
    Expense_Entry,Invoice,
    SalesMode,Invoice_Test, 
    Invoice_File, Invoice_File_Category, Receipt
)
...
class Invoice_Test_Serializer(serializers.ModelSerializer):
    ...
    def get_without_header_footer(self,obj):
        if obj.signature:
            ...
            img_tag = soup.find('img', {'src': 'http://app.covaicivillab.com/static/header.gif'})
            if img_tag:
                img_tag.extract()
            ...
            data = data.replace(f'<img alt="Logo" src="{settings.BACKEND_DOMAIN}/static/header.gif"/>','')                        
            data = data.replace('<tr>','',1)
            data = data.replace('<td colspan="2">','',1)
            data = data.replace('</td>','',1)
            data = data.replace('</tr>','',1)
            data = data + f'<figure class="table"><table cellpadding="0" cellspacing="1" border="0" style="border:none !important; border-spacing:0.6pt; width:100%"><tr><td width="40%" style="border:none !important;"><p id="dynamic-signature"></p><p><img src="{settings.BACKEND_DOMAIN}/static/ragu r.png" height="150px" width="150px"></p><p style="text-align:justify"><strong style="font-size:12px">M.RAGURAM, ME (STRUCTURAL)., AMIE <br>CHARTERED ENGINEER (AM1818123)<br></strong></p><p style="font-size:12px"><strong>Covai Civil Lab Private Limited</strong></p></td><td width="40%" style="border:0 !important;"><p id="dynamic-signature"><img src="{settings.BACKEND_DOMAIN}/media/'+str(obj.signature.signature)+'" height="150px" width="150px"></p><p style="font-size:12px"><strong style="font-size:12px">'+str(obj.signature)+'<br>'+str(obj.signature.role)+f'</strong></p><p style="font-size:12px"><strong>Covai Civil Lab Private Limited</strong></p></td><td width="20%" style="border:0 !important;" class="qr-code"><img src="{settings.BACKEND_DOMAIN}/api/'+str(obj.invoice_image)+'"></td></tr></table></figure>'
            soup = BeautifulSoup(data, 'html.parser')
            ...
            data = data.replace('</td>','',1)
            data = data.replace('</tr>','',1)
            data = data + f'<figure class="table"><table cellpadding="0" cellspacing="1" border="0" style="border:none !important; border-spacing:0.6pt; width:100%"><tr><td width="40%" style="border:0 !important;"><p id="dynamic-signature"></p><p style="font-size:12px"><strong style="font-size:12px"><br><br>Authorised Signatory</strong></p><p style="font-size:12px"><strong>Covai Civil Lab Private Limited</strong></p></td><td width="40%" style="border:none !important;"><p></p><p style="text-align:justify"></p></td><td width="20%" style="border:0 !important;" class="qr-code"><img src="{settings.BACKEND_DOMAIN}/api/'+str(obj.invoice_image)+'"></td></tr><tr><td colspan="3" style="border:0 !important;"><hr style="color: #000;"></td></tr><tr style="border-spacing:0.6pt; border:0 !important;"><td colspan="3" style="border:0px !important; border-style:inset; border-width:0.75pt; vertical-align:middle"></td></tr></table></figure>'
            soup = BeautifulSoup(data, 'html.parser')
            first_table = str(soup.select_one("table:nth-of-type(1)"))    
    ...
    def get_without_signature(self,obj): 
        ...
        if obj.signature:   
            ...
            data = data.replace('</td>','',1)
            data = data.replace('</tr>','',1)
            data = data + f'<figure class="table"><table cellpadding="0" cellspacing="1" border="0" style="border:none !important; border-spacing:0.6pt; width:100%"><tr><td width="40%" style="border:none !important;"><p><img style="visibility: hidden;" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" height="38px" width="38px"></p><p id="dynamic-signature"></p><p style="text-align:justify"><strong style="font-size:12px">M.RAGURAM, ME (STRUCTURAL)., AMIE <br>CHARTERED ENGINEER (AM1818123)</strong></p><p style="font-size:12px"><strong>Covai Civil Lab Private Limited</strong></p></td><td width="40%" style="border:0 !important;"><p><img style="visibility: hidden;" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" height="38px" width="38px"></p><p id="dynamic-signature"></p><p style="font-size:12px"><strong style="font-size:12px">'+str(obj.signature)+'<br>'+str(obj.signature.role)+f'</strong></p><p style="font-size:12px"><strong>Covai Civil Lab Private Limited</strong></p></td><td width="20%" style="border:0 !important;" class="qr-code"><img src="{settings.BACKEND_DOMAIN}/api/'+str(obj.invoice_image)+'"></td></tr></table></figure>'
            soup = BeautifulSoup(data, 'html.parser')
            first_table = str(soup.select_one("table:nth-of-type(1)"))    
    ...
    def get_final_html(self,obj):
        ...
        if obj.signature:
            ...
            if obj.invoice.is_old_invoice_format:
                data = data + f'<figure class="table"><table cellpadding="0" cellspacing="1" border="0" style="border:none !important; border-spacing:0.6pt; width:100%"><tr><td width="40%" style="border:none !important;"><p><img src="{settings.BACKEND_DOMAIN}/static/ragu r.png"  height="150px" width="150px"></p><p style="font-size:12px"><strong  style="font-size:12px">M.RAGURAM, ME (STRUCTURAL)., AMIE <br>CHARTERED ENGINEER (AM 1818123)<br>COVAI CIVIL TECH LAB </strong></p></td><td width="40%"  style="border:0 !important;"><p id="dynamic-signature"><img src="{settings.BACKEND_DOMAIN}/api/media/'+str(obj.signature.signature)+'" height="150px" width="150px"></p><p style="font-size:12px"><strong style="font-size:12px">'+str(obj.signature)+'<br>'+str(obj.signature.role)+f'</strong></p><p style="font-size:12px"><strong>COVAI CIVIL TECH LAB</strong></p> </td> <td width="20%"  style="border:0 !important;" class="qr-code"> <img src="{settings.BACKEND_DOMAIN}/api/'+str(obj.invoice_image)+f'" ></td> </tr> <tr><td colspan="3" style="border:0 !important;"> <hr style="color: #000;"></td></tr> <tr style="border-spacing:0.6pt; border:0 !important;"> <td colspan="3" style="border:0px !important; border-style:inset; border-width:0.75pt; vertical-align:middle"> <p><img alt="Logo" src="{settings.BACKEND_DOMAIN}/static/test-footer.png" style="width:100%" /></p> </td> </tr> </table></figure>'
                ...
                data = data + f'<figure class="table"><table cellpadding="0" cellspacing="1" border="0" style="border:none !important; border-spacing:0.6pt; width:100%"><tr><td width="40%" style="border:none !important;"><p><img src="{settings.BACKEND_DOMAIN}/static/ragu r.png"  height="150px" width="150px"></p><p style="font-size:12px"><strong  style="font-size:12px">M.RAGURAM, ME (STRUCTURAL)., AMIE <br>CHARTERED ENGINEER (AM 1818123)<br>Covai Civil Lab Private Limited</strong></p></td><td width="40%"  style="border:0 !important;"><p id="dynamic-signature"><img src="{settings.BACKEND_DOMAIN}/api/media/'+str(obj.signature.signature)+'" height="150px" width="150px"></p><p style="font-size:12px"><strong style="font-size:12px">'+str(obj.signature)+'<br>'+str(obj.signature.role)+f'</strong></p><p style="font-size:12px"><strong>Covai Civil Lab Private Limited</strong></p> </td> <td width="20%"  style="border:0 !important;" class="qr-code"> <img src="{settings.BACKEND_DOMAIN}/api/'+str(obj.invoice_image)+f'" ></td> </tr> <tr><td colspan="3" style="border:0 !important;"> <hr style="color: #000;"></td></tr> <tr style="border-spacing:0.6pt; border:0 !important;"> <td colspan="3" style="border:0px !important; border-style:inset; border-width:0.75pt; vertical-align:middle"> <p><img alt="Logo" src="{settings.BACKEND_DOMAIN}/static/test-footer.png" style="width:100%" /></p> </td> </tr> </table></figure>'
            return data
        elif obj.is_authorised_signatory:
            data = obj.report_template
            data = data.replace('Page Break','<div class="pagebreak"> </div>')
            data = data + f'<figure class="table"><table cellpadding="0" cellspacing="1" border="0" style="border:none !important; border-spacing:0.6pt; width:100%"><tr><td width="40%" style="border:0 !important;"><p id="dynamic-signature"></p><p style="font-size:12px"><strong style="font-size:12px"><br><br>Authorised Signatory</strong></p><p style="font-size:12px"><strong>Covai Civil Lab Private Limited</strong></p></td><td width="40%" style="border:none !important;"><p></p><p style="text-align:justify"></p></td><td width="20%" style="border:0 !important;" class="qr-code"><img src="{settings.BACKEND_DOMAIN}/api/media/'+str(obj.invoice_image)+f'"></td></tr><tr><td colspan="3" style="border:0 !important;"><hr style="color: #000;"></td></tr><tr style="border-spacing:0.6pt; border:0 !important;"><td colspan="3" style="border:0px !important; border-style:inset; border-width:0.75pt; vertical-align:middle"><p><img alt="Logo" src="{settings.BACKEND_DOMAIN}/static/test-footer.png" style="width:100%" /></p></td></tr></table></figure>'
            return data
...
class Invoice_File_Serializer(serializers.ModelSerializer):
    ...
    def get_file_url(self, obj):
        return f"{settings.BACKEND_DOMAIN}/media/"+str(obj.file)
...
class Invoice_Serializer_For_Print(serializers.ModelSerializer):
    ...
    def get_qr(self,obj):
        if obj.invoice_image:
            return f"{settings.BACKEND_DOMAIN}/"+obj.invoice_image
        else:
            return ""
...
class Invoice_Serializer_For_Dashboard(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = ['id','invoice_no','total_amount','customer','sales_mode','project_name','discount','advance','balance','place_of_testing']
