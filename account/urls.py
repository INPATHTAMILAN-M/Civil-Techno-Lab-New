...
urlpatterns = [
    ...
    path('employee-password-change/', views.ChangePasswordView.as_view(), name='change-password'),
    path('admin-password-change/', views.AdminChangePasswordView.as_view(), name='admin-change-password'),
    ...
    path('employees/<int:id>/delete/', views.EmployeeDeleteView.as_view(), name='employee-delete'),
